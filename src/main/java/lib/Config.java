...
public class Config {
    ...
    public static int getBrowserDimensionX() {
        return getValueForProperty(BROWSER_DIMENSION_X);
    }

    public static int getBrowserDimensionY(){
        return getValueForProperty(BROWSER_DIMENSION_Y);
    }
    ...
    private static int getValueForProperty(String propertyName) {
